...
@Autowired
  ...
  @GetMapping(produces = MediaType.APPLICATION_JSON_VALUE, params = {"pool-size", "code-length", "games-played"})
  List<GameStatistics> get(@RequestParam("pool-size") int poolSize, @RequestParam("code-length") int codeLength, @RequestParam("games-played") int gamesPlayed) {
