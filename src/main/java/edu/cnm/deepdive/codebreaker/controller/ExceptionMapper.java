...
public class ExceptionMapper {
  ...
  @ResponseStatus(value = HttpStatus.BAD_REQUEST, reason = "Guess must only contain characters")
  public void invalidGuessCharacter() {}

  @ExceptionHandler(GameAlreadySolvedException.class)
  @ResponseStatus(value = HttpStatus.CONFLICT, reason = "Guess cannot be accepted for a completed game")
